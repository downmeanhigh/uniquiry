...
export default function life() {
  ...
  return (
    <TableContainer component={Paper}>
      ...
      Life sciences courses provide comprehensive training on the essential concepts and the latest research techniques critical to the diverse spectrum of disciplines within and beyond biological and biomedical fields. From molecular and cellular worlds to organismal individuals, and from macro-level ecological views to underlying evolutionary concepts, different aspects of life sciences contribute to our understanding of how humans work, and how we interact with, and impact our environment.
      </div>
      <div style={{marginLeft: 45, width: '80%'}}>
      You can find more information in https://www.dbs.nus.edu.sg/education/lifesciences/
      </div>
    </TableContainer>
  );
}