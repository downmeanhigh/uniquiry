...
export default function eng_sci() {
  ...
  return (
    <TableContainer component={Paper}>
      ...
      This course aims at combining strong science fundamentals with cutting-edge engineering applications, so that Engineering Science Programme (ESP) graduates can effectively contribute to solving the many complex multi-disciplinary challenges of our time, such as problems in communication, transportation, energy production, health, security, and environment.

ESP prepares graduates to work at this interface between science and engineering. Graduates will be able to conduct basic scientific research and develop discoveries into marketable products.


      </div>
      <div style={{marginLeft: 45, width: '80%'}}>
      You can find more information in https://www.eng.nus.edu.sg/esp/
      </div>
    </TableContainer>
  );
}