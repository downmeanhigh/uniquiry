...
export default function Aero_eng() {
  ...
  return (
    <TableContainer component={Paper}>
      ...
      This course aims to prepare students for successful careers and the ability to engage in life-long learning by training students to apply knowledge of mathematics, science and engineering to the solution of engineering problems. The course also aims to develop students’ skills in engineering design process, including the ability to formulate problems, to think creatively, to communicate effectively, to synthesize solutions to achieve desired needs.
    
      </div>
      <div style={{marginLeft: 45, width: '80%'}}>
      You can find more information in https://www.ntu.edu.sg/education/undergraduate-programme/bachelor-in-aerospace-engineering
      </div>
    </TableContainer>
  );
}