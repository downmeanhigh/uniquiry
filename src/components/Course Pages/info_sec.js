...
With the recent developments in technology, keeping everything secure has never been more relevant in this day and age. From cryptography and malware detection to social engineering and security law, you will gain a foundation in security that includes both the technical and social aspects of the subject.

      </div>
      <div style={{marginLeft: 45, width: '80%'}}>
      You can find more information in https://www.comp.nus.edu.sg/programmes/ug/isc/
      </div>
    </TableContainer>
  );
}