...
export default function Mse() {
  ...
  return (
    <TableContainer component={Paper}>
      ...
      Materials Science and Engineering is a discipline that enables the creation and application of materials in society. New materials have always been among the greatest achievements of humans since the beginning of history. It is always advanced materials that open the door to new technologies and breakthroughs, whether they are in chemical, mechanical, aeronautical, energy, electrical, manufacturing industry, civil or biomedical engineering. New and advanced materials are the inevitable part of the newly emerging nanoscience and nanotechnology, which are revolutionizing the way that we live, work and stay healthy.

      </div>
      <div style={{marginLeft: 45, width: '80%'}}>
      You can find more information in https://www.eng.nus.edu.sg/mse/
      </div>
    </TableContainer>
  );
}